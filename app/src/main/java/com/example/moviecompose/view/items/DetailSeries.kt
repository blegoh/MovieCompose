...
fun DetailSeries(seriesDetail: SeriesDetail, onBack: () -> Unit) {
    Column {
        AsyncImage(
            model = "https://image.tmdb.org/t/p/w500/${seriesDetail.backdropPath}",
        ...
        Text(
            text = seriesDetail.name.toString(), style = TextStyle(
        ...
        Row(modifier = Modifier.padding(horizontal = 16.dp)) {
            Text(text = seriesDetail.firstAirDate?.split("-")?.firstOrNull() ?: "", color = Gray3)
